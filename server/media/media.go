...
type Handler interface {
	...
	Headers(tenantID types.TenantID, method string, url *url.URL, headers http.Header, serve bool) (http.Header, int, error)
	...
	Download(tenantID types.TenantID, url string) (*types.FileDef, ReadSeekCloser, error)
